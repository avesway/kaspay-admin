...
const ProductsExpiredItem = ({ product }) => {
  return (
    <div className="flex items-center mb-3 justify-between rounded-lg border bg-amber-100 p-4 cursor-pointer transition-all hover:scale-[1.01] hover:shadow-md max-sm:flex-col max-sm:gap-5">
