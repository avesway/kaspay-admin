...
import {
  getProductsBalances,
  setPaginationProductsBalances,
} from '@/modules/products/productsBalances/productsBalances.processes';
        ...
        return (
          <div className="flex flex-col">
            ...
            {originalId === activeProduct.productId && activeProduct.originalSalePrice != null ? (
              <span className="mt-2 text-[12px]">Пред. : {activeProduct.originalSalePrice}</span>
            ) : null}
          </div>
        );
      },
        ...
        return (
          <div className="flex flex-col">
            ...
            {originalId === activeProduct.productId && activeProduct.originalDiscountRate != null ? (
              <span className="mt-2 text-[12px]">Пред. : {activeProduct.originalDiscountRate}</span>
            ) : null}
          </div>
        );
      },
