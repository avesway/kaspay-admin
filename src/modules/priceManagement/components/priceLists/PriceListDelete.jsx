...
const PriceListDelete = ({ priceList }) => {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {`Вы действительно хотите удалить прайс лист ${priceList.name}? Это действие нельзя отменить.`}
          </DialogDescription>
        </DialogHeader>
        <DialogFooter className="sm:justify-start mt-5">
          ...
          <Button
            ...
            className="ml-auto"
            onClick={() => deletePriceList(priceList.id, setOpen)}
          >
            Удалить
